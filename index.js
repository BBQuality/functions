...
console.log("isEvenNumber(3)", isEvenNumber(3)); // Виведе: false
...
function calculateSum(n) {
  let sum = 0;
  calculateSum: for (let i = 1; i <= n; i++) {
 sum = i;
    if (i!==n){
...
console.log("isPrimeNumber(3)", isPrimeNumber(3)); // Виведе: true
console.log("isPrimeNumber(5)", isPrimeNumber(5)); // Виведе: true
console.log("isPrimeNumber(7)", isPrimeNumber(7)); // Виведе: true
console.log("isPrimeNumber(10)", isPrimeNumber(10)); // Виведе: false
console.log("isPrimeNumber(9)", isPrimeNumber(9)); // Виведе: false
...
console.log("isPositiveNumber(2)", isPositiveNumber(2)); // Виведе: true
console.log("isPositiveNumber(-7)", isPositiveNumber(-7)); // Виведе: false
console.log("isPositiveNumber(-9)", isPositiveNumber(-9)); // Виведе: false
console.log("isPositiveNumber(0)", isPositiveNumber(0)); // Виведе: false
console.log("isPositiveNumber(3)", isPositiveNumber(3)); // Виведе: true
...
console.log("factorial(5)", factorial(0)); // Виведе: 120
...
let cube = function (n) {
  return (n => 1) ? n = n * n * n : 0;
};

console.log("Завдання 16 ====================================");
console.log("cube(3)", cube(3)); // Виведе: 27
console.log("cube(5)", cube(5)); // Виведе: 27
console.log("cube(6)", cube(6)); // Виведе: 27
console.log("cube(10)", cube(10)); // Виведе: 27
